...
#ifndef TPZMIXEDCOMPRESSIBLEDARCYFLOW_H
#define TPZMIXEDCOMPRESSIBLEDARCYFLOW_H
...
/**
 * @ingroup material
 * @brief This class implements a slightly compressible mixed Darcy material to solve iteratively the incompressible Darcy flow equation for isotropic materials.
 *
...
class TPZMixedCompressibleDarcyFlow : public TPZMatBase<STATE, TPZMatCombinedSpacesT<STATE>,
...
public:
     ...
     */
    TPZMixedCompressibleDarcyFlow();

    /**
	 * @brief Class constructor
	 * @param [in] id material id
	 * @param [in] dim problem dimension
     * @param [in] alpha compressibility parameter
	 */
    [[maybe_unused]] TPZMixedCompressibleDarcyFlow(int id, int dim, REAL alpha);

    /**
             copy constructor
     */
    TPZMixedCompressibleDarcyFlow(const TPZMixedCompressibleDarcyFlow &copy);
    /**
             copy constructor
     */
    TPZMixedCompressibleDarcyFlow &operator=(const TPZMixedCompressibleDarcyFlow &copy);
    /**
	 * @brief Returns a 'std::string' with the name of the material
	 */
    [[nodiscard]] std::string Name() const override { return "TPZMixedCompressibleDarcyFlow"; }

    /**
	 * @brief Returns the alpha parameter
     */
    [[nodiscard]] REAL Alpha() const { return fAlpha; }
    ...
    /**
     * @brief Sets the compressibility parameter
     */
...
#endif //TPZMixedCompressibleDARCYFLOW_H
